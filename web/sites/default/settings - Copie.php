 ...
 * @endcode
 */
$settings['hash_salt'] = 'LJEFc2F3yH_oFpDS_tgy8HoHj21_EMe3nzkO2NYW8D2tM4S-1m8cO4ZVv_iPT3YxlRkyRCo-Ug';
 ...
 */
  $settings['trusted_host_patterns'] = [
    // '^www\.example\.com$',
    // '^greta-cfa-gipdaifi\.com$',
    '^atom-eco.fr\.loc$',
    '^atom-eco.fr.koncept47\.net$'
  ];
...
$databases['default']['default'] = array (
  'database' => 'sc1bpwx1045_atom-eco.fr',
  'username' => 'sc1bpwx1045_atomeco',
  'password' => 'B5JQVgpJ(qVS',
  'prefix' => '',
  'host' => 'localhost',
  'port' => '3306',
...
$settings['config_sync_directory'] = 'sites/default/files/config_oxw7RO6mF_oiDAJZ7-WPmxOcFJaQtWxH7NtYuOJqC087oJ6BQP1y5SvW30W4QXzEOlSKgvxXng/sync';
